...
alex_table = listArray (0 :: Int, 1072)
  [ 0
  , 9
  , 9
  , 9
...
alex_check = listArray (0 :: Int, 1072)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_7 = tok (const TokenTimes)
alex_action_8 = tok (const TokenLParen)
alex_action_9 = tok (const TokenRParen)
